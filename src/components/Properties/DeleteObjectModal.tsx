...
export function DeleteObjectModal({ isOpen, onClose, onObjectDeleted, object }: DeleteObjectModalProps) {
      ...
      <div className="bg-white rounded-2xl max-w-md w-full">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">Delete Object</h2>
        ...
        <div className="p-6">
          <div className="flex items-start space-x-4 mb-6">
            <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{backgroundColor: '#8d2138'}}>
              <Building2 className="w-6 h-6 text-white" />
            </div>
            <div className="flex-1">
              <p className="text-gray-700 mb-2">
                Are you sure you want to delete <span className="font-semibold">{object.name}</span>?
              </p>
              {object.properties && object.properties.length > 0 && (
                <p className="text-sm text-red-600 font-medium">
                  Warning: This object contains {object.properties.length} propert{object.properties.length === 1 ? 'y' : 'ies'}. 
