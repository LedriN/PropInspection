...
export function AddObjectModal({ isOpen, onClose, onObjectAdded }: AddObjectModalProps) {
      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">Add New Object</h2>
              <p className="text-sm text-gray-600">Create a new object to group properties</p>
            </div>
          </div>
          <button
            onClick={onClose}
